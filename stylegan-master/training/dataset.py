...
from training.dataset_util import save_wsi_thumbnail_mask, get_random_wsi_batch, get_slide_label
...
class WSIDataset:
    ...
    def __init__(self,
        ...
        resolution      = 1024,     # Dataset resolution, None = autodetect.
...
def load_dataset(class_name=None, data_dir=None, verbose=False, **kwargs):
    ...
    if 'tfrecord_dir' in kwargs:
        if class_name is None:
            class_name = __name__ + '.WSIDataset'
