...
def training_loop(
    ...
    resume_pkl              = './results/00000-stylegan2-VAE-GAN-Data-2gpu-config-e/network-snapshot-002252.pkl',     # Network pickle to resume training from, None = train from scratch.
    resume_kimg             = 002252.0,      # Assumed training progress at the beginning. Affects reporting and training schedule.
